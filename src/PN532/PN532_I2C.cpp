...
{
    delay(200); // wait for all ready to manipulate pn532
}
...
int8_t PN532_I2C::readAckFrame()
{
    ...
    do {
        ...
        if (time > PN532_ACK_WAIT_TIME) {
            DMSG(F("Time out when waiting for ACK\n"));
